        ...
        <ItemTemplate>
            <div class="col-md-3">
                <div class="card destination-card">
                    <img src='<%# Eval("ImageURL") %>' alt="Destination Image" style="width: 600px; height: 300px;" />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control" placeholder="Enter destination price" Required="true" onkeypress="return isNumberKey(event)"></asp:TextBox>
                <span id="priceValidation" style="color: red;"></span>
            </div>
            ...
            <asp:PostBackTrigger ControlID="btnAddDestination" />
             ...
             <script type="text/javascript">
                 function validateForm() {
                     ...
                     var priceTextBox = document.getElementById('<%=txtPrice.ClientID%>');
                     var priceValidation = document.getElementById('priceValidation');
                     var priceValue = priceTextBox.value.trim();

                     if (isNaN(priceValue) || priceValue === '') {
                         priceValidation.innerHTML = 'Please enter a valid numeric value for the price.';
                         isValid = false;
                     } else {
                 ...
                 function isNumberKey(evt) {
                     ...
                     if (charCode > 31 && (charCode < 48 || charCode > 57)) {
                         document.getElementById('priceValidation').innerHTML = 'Please enter numbers only.';
                         return false;
                     }
